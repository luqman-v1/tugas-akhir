          ...
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
             ...
             <tr class="item{{$data->id}}">
              ...
              <td> 
               <button data-toggle="modal" data-id="{{$data->id}}" id="ubah" value="{{$data->id}}" data-target=".bs-example-modal-sm1" class="btn-xsm btn-warning"><span class="glyphicon glyphicon-edit"></span> Ubah</button>
