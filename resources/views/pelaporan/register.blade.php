						...
						<form action="{{url('laporan/register')}}" method="post">
							...
							<div class="form-group">
								<div class="radio-inline">
									<label>
										<input type="radio" class="flat-red" name="register" id="optionsRadios1" value="RJ" checked="">
										 R.Jalan
									</label>
								</div>
								...
								<div class="radio-inline">
									<label>
										<input type="radio" class="flat-red" name="register" id="optionsRadios1" value="RI" >
										 R.Inap
									</label>
								</div>
								...
								<div class="radio-inline">
									<label>
										<input type="radio" class="flat-red" name="register" id="optionsRadios1" value="KRS" >
							...
							<div class="col-md-12">
								<button type="submit" class="btn btn-primary btn-block btn-lg">Lihat <span class="glyphicon glyphicon-zoom-in"></span></button>
							</div>
						</form>
					</div>
				</div>
