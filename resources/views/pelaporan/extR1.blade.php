...
<div class="row">
  <p style="text-align: center;"><img style="height: 80px;width: auto;margin-top: -10px;" src="{{url('/logos.png')}}"></p>
    <p  style="text-align: center;"><b><font size="5" face="Courier New">Formulir RL 5.1</font></b></p>
    <p  style="text-align: center;"><b><font size="4" face="Courier New">PENGUNJUNG RUMAH SAKIT</font></b></p>
